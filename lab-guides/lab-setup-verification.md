...
3. Make a note of the stack output parameters. You can find the stack output parameters in the **Outputs** tab.You will need these parameters later in the workshop.
